...
public class CAMERA extends ACTIVITY {
	 ...
	 * */
	public static void openCamera(boolean edit,final CALLBACK<Bitmap> callback) {
		ACTIVITY.openCamera(edit,callback);
	}
	...
	public static void openGallery(boolean edit,final CALLBACK<Bitmap> callback) {
		ACTIVITY.openGallery(edit,callback);
	}
