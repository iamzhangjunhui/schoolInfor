...
//	};
    ...
    public static void downLoad(final String path , final String url, Map<String, Object> parameters,
                                Mode mode, final CALLBACK<Boolean> callback, final ProgressBar pb) {
        ...
        try {
            ...
            asyncTask = new AsyncTask<HttpRequestBase, Integer, Boolean>() {
                @Override
                protected Boolean doInBackground(HttpRequestBase... params) {
                ...
                protected void onPostExecute(Boolean result) {
                    callback.run(result == null, result);
                }
            ...
            if (files != null) {
                if (files.keySet() != null) {
                    for (String key : files.keySet()) {
                        ...
                        multipartEntity.addPart(key, key , file, false);
                    }
                }
            }
